...
class Student(models.Model):
    ...
    parents_phone = models.CharField('телефон родителей', max_length=255)
    email = models.EmailField('email', null=True, blank=True)
    birthday = models.DateField('дата рождения')
    time_preference = JSONField('желаемое время', default=EMPTY_FREE_TIME_JSON)
    passport_number = models.CharField('паспорт, серия/номер', max_length=15)
    passport_authority = models.CharField('паспорт, кем выдан', max_length=255)
