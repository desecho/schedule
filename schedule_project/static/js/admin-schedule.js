...
angular.module('roomHour', ['ngResource']).
  factory('RoomHour', function($resource) {
    return $resource('/room-hour/', {}, {
      get: {method: 'GET'}
    });
  });
...
function ScheduleController($scope, $route, $routeParams, $location, $dialog, Schedule, Settings) {
  ...
  $scope.openDialog = function(event){
    ...
    var opts = {
      ...
      keyboard: true,
      backdropClick: true,
      templateUrl:  '/schedule_modal',
      controller: 'DialogController',
      resolve: {
        free: function(){
          return $.inArray(room_hour_code, schedule) == -1;
        },
...
function DialogController($scope, dialog, free, room_hour_code, schedule_mode, RoomHour, TeachersAndStudents, ScheduleSave, ScheduleDelete){
  ...
  $scope.load = function() {
    ...
    RoomHour.get(params, function (data) {
